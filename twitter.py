...
class TwitterClient(object):
    ...
    def __init__(self, query, retweets_only=False, with_sentiment=False):
        ...
        access_token = '785123558879993857-jLlJqxvCxnCgN7crwPONUi7LPX2ZTCu'
        access_token_secret = 'h5EhJ2dwDEIyAIpoFrGI3gI2PgbPrsx6oXppxh73vKdvz'
        ...
        try:
            ...
            self.tweet_count_max = 200  # To prevent Rate Limiting
        except:
